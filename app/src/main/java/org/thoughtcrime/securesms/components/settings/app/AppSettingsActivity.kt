...
class AppSettingsActivity : DSLSettingsActivity(), GooglePayComponent {
  ...
  override fun onCreate(savedInstanceState: Bundle?, ready: Boolean) {
    ...
    val startingAction: NavDirections? = if (intent?.categories?.contains(NOTIFICATION_CATEGORY) == true) {
      ...
      when (appSettingsRoute) {
        ...
        AppSettingsRoute.AccountRoute.LinkBaAccount -> AppSettingsFragmentDirections.actionDirectToLinkBaAccount()
  ...
  companion object {
    ...
    @JvmStatic
    fun linkBaAccount(context: Context): Intent = getIntentForStartLocation(context, AppSettingsRoute.AccountRoute.LinkBaAccount)
